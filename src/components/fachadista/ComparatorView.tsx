  ...
  return (
    <main className="flex-1 max-w-[1600px] mx-auto w-full px-4 py-4 md:px-8 lg:px-12 md:py-8 flex flex-col gap-5 md:gap-10 animate-in fade-in duration-500">
      ...
      {!beforeImage || !afterImage ? (
        ...
        <div className="w-full max-w-6xl mx-auto space-y-5 md:space-y-8 <div className="w-full max-w-6xl mx-auto space-y-5 md:space-y-8 animate-in fade-in duration-500">">
          {/* Labels */}
